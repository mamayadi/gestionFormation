...
public class AdminServiceController {
	...
	public ResponseEntity<DeleteResponse> deleteAdmin(@PathVariable("id") Long id) {
		adminService.deleteAdmin(id);
		return new ResponseEntity<DeleteResponse>(new DeleteResponse("Admin is deleted successfully"), HttpStatus.OK);
	}
